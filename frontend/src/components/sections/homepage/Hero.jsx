    ...
    <section className="relative bg-[#07112B] text-white overflow-hidden min-h-[calc(100dvh-72px)] md:min-h-[calc(100dvh-81px)]">
      <div className="max-w-360 mx-auto flex flex-wrap items-start min-h-[calc(100dvh-72px)] md:min-h-[calc(100dvh-81px)] relative z-10 pointer-events-none">
        <div className="pointer-events-auto flex-[1_1_320px] max-w-200 pt-[clamp(2.5rem,2rem+4vw,7.5rem)] pr-6 md:pr-12 lg:pr-22 pb-[clamp(2rem,1.5rem+3vw,3.75rem)] pl-6 md:pl-12 lg:pl-22 relative z-2">
          ...
          <p className="font-display text-lead font-medium leading-[1.36] mb-[clamp(1.5rem,1.2rem+2vw,2.5rem)] text-white max-sm:[text-shadow:0px_2px_4px_rgba(0,0,0,0.7)]">
          ...
          <div className="flex flex-wrap gap-4 sm:gap-16 mb-[clamp(2rem,1.5rem+3vw,5rem)]">
          ...
          <div className="flex flex-wrap gap-[clamp(1.5rem,1rem+3vw,4rem)]">
            <div className="flex flex-row items-center gap-3">
              ...
              />
              <div>
                <p className="font-body text-h1 font-semibold leading-none max-sm:[text-shadow:0px_2px_4px_rgba(0,0,0,0.7)]">
                  20
                </p>
                <p className="font-display text-small font-normal text-white tracking-[-0.28px] [text-shadow:0px_4px_4px_rgba(0,0,0,0.1)] max-sm:[text-shadow:0px_2px_4px_rgba(0,0,0,0.7)] mt-0">
