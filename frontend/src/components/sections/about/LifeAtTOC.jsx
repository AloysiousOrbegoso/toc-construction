    ...
    <section className="bg-[#f6f6f6] pt-[77px] pb-24">
      <div className="mx-auto w-full max-w-360 px-22">
        ...
        <div className="grid grid-cols-2 gap-5">
          <div className="relative flex flex-col gap-[11px] rounded-2xl border border-[#c5c5d3] px-[41px] pt-[75px] pb-[41px] text-center">
            <img
              src={safetyIcon}
              alt=""
              className="absolute -top-8 left-1/2 h-16 w-16 -translate-x-1/2 rounded-full object-contain"
            />
            <h3 className="font-display text-[21px] font-semibold text-black">Safety First</h3>
            <p className="font-display text-[21px] leading-[1.22] text-black">
          ...
          <div className="relative flex flex-col gap-[11px] rounded-2xl border border-[#c5c5d3] px-[41px] pt-[75px] pb-[41px] text-center">
            <img
              ...
              className="absolute -top-8 left-1/2 h-16 w-16 -translate-x-1/2 rounded-full object-contain"
            />
            <h3 className="font-display text-[21px] font-semibold text-black">Growth</h3>
            <p className="font-display text-[21px] leading-[1.22] text-black">
          ...
          <div className="relative flex flex-col gap-[11px] rounded-2xl border border-[#c5c5d3] px-[41px] pt-[75px] pb-[41px] text-center">
            <img
              ...
              className="absolute -top-8 left-1/2 h-16 w-16 -translate-x-1/2 rounded-full object-contain"
            />
            <h3 className="font-display text-[21px] font-semibold text-black">Teamwork</h3>
            <p className="font-display text-[21px] leading-[1.22] text-black">
          ...
          <div className="relative flex flex-col gap-[11px] rounded-2xl border border-[#c5c5d3] px-[41px] pt-[75px] pb-[41px] text-center">
            <img
              ...
              className="absolute -top-8 left-1/2 h-16 w-16 -translate-x-1/2 rounded-full object-contain"
            />
            <h3 className="font-display text-[21px] font-semibold text-black">Innovation</h3>
            <p className="font-display text-[21px] leading-[1.22] text-black">
