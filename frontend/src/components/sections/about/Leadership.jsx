    ...
    <section className="bg-white py-24">
      <div className="mx-auto w-full max-w-360 px-22">
        <div className="mb-[46px] text-center">
          <span className="mb-4 block font-display text-[21px] font-medium uppercase tracking-[0.067em] text-black">
            Our Leadership
          </span>
          <h2 className="font-display text-[40px] font-semibold text-[#1a1c1c]">
        ...
        <div className="grid grid-cols-4 justify-items-center gap-5">
          <div className="flex flex-col items-center text-center">
            ...
            <h3 className="mb-2 font-body text-[21px] font-semibold text-[#00195c]">
              Engr. Robi Balboa
            </h3>
            <span className="font-display text-[14px] font-semibold tracking-[0.1em] text-[#444651]">
