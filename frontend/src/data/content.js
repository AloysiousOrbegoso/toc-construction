...
export const projectsPageContent = {
  ...
  categories: ["All", "Furnitures", "Infrastructure", "Homes"],
    ...
    },
    {
      ...
      engineers: [
        "BHC (Civil)",
        "Voltage Engineering (Electrical)",
        "Structural Engineering Associates, Inc. (Structural)",
      ],
      contactPerson: {
        name: "Marcus Lee",
        role: "Site Manager, New York City",
    ...
    },
    {
      ...
      contactPerson: {
        name: "Glen Austin",
        role: "VP President, Kansas City",
        phone: "+1 (816) 555-0173",
